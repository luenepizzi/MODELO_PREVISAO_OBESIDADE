...
def aba_dashboard(pipeline):
    ...
    if os.path.exists(arquivo_predicoes):
        ...
        col1.metric("Total Pacientes", f"{total_pacientes}")
        ...
        # Tabela completa
        st.subheader("Tabela Completa dos Pacientes (Filtrada)")
        st.dataframe(df_filtrado)

    else:
        st.warning("Nenhum dado encontrado! Faça previsões na aba 'Previsão Individual'.")
